...
# ctest_configure_options_file : command line options to pass the configure step.
# ctest_test_args_file : arguments to pass to ctest_test() command e.g.
#                   "PARALLEL_LEVEL 1 EXCLUDE SurfaceLIC"
...
if (EXISTS "${ctest_test_args_file}")
    file(READ "${ctest_test_args_file}" ctest_test_args)
endif()
